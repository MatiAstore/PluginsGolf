(function ($) {
    $(document).ready(function () {
        ...
        // Inicializa flatpickr en la carga de la página
        initializeFlatpickr();

        // Vuelve a inicializar flatpickr cuando cambie el tamaño de la pantalla
        $(window).on('resize', function() {
            // Asegúrate de que flatpickr se esté aplicando
            initializeFlatpickr();
        });

        // Evento al seleccionar un club para mostrar el formulario
        $('#resultados_clubes').on('click', '.seleccionar-club', function () {
        ...
        $('#form_partida').on('submit', function (e) {
            ...
            $.ajax({
                url: registroPartidaData.ajaxurl,
                type: 'POST',
                data: {
                ...
                success: function (response) {
                    ...
                    // Resetear el formulario después de registrar la partida
